...
class ErrorDeserializedException extends AbstractBusinessException{
    ...
    ErrorDeserializedException(String message, Object datail) {
        super(message, datail)
    }

    ErrorDeserializedException(String message, Throwable cause, Object datail) {
        super(message, cause, datail)
    }

    ErrorDeserializedException(Throwable cause, Object datail) {
        super(cause, datail)
    }
}
